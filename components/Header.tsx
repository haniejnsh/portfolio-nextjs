...
export default function Header() {
    ...
    const navStyle=`${showMenu?" bg-[#ffffffe2] opacity-100 absolute ":"opacity-0 absolute"} right-0 top-0 w-full h-full  flex justify-center transition-all duration-[1000ms] lg:transition-none lg:duration-[0ms] lg:static lg:opacity-100 lg:h-auto lg:w-auto lg:grow-1 lg:justify-end`
