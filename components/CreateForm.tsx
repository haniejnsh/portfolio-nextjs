...
export default function CreateForm({handleShowForm} : PropsType) {
    const [state,formAction]=useFormState(createNote, {message: ""});
  ...
  return (
    ...
    >
        ...
        >
            ...
            <h2 className="text-lg font-bold text-stone-700">Note create form</h2>
            <label 
            htmlFor="title" 
